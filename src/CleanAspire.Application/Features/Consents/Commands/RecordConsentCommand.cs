...
/// <summary>
/// Command for recording a new consent.
/// Phase 4: LGPD Compliance - Consent & Data Privacy
/// </summary>
public record RecordConsentCommand : IFusionCacheRefreshRequest<ConsentDto>, IRequiresValidation
{
...
/// <summary>
/// Handler for processing RecordConsentCommand.
/// Records a new consent entity and raises appropriate domain events.
/// </summary>
public class RecordConsentCommandHandler : IRequestHandler<RecordConsentCommand, ConsentDto>
{
    ...
    public async ValueTask<ConsentDto> Handle(RecordConsentCommand request, CancellationToken cancellationToken)
    {
        // Validate tenant
        ...
        if (existingConsent != null)
        {
            ...
            existingConsent.UserAgent = request.UserAgent;
