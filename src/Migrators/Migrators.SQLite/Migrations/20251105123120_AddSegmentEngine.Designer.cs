...
namespace CleanAspire.Migrators.SQLite.Migrations
{
    ...
    [Migration("20251105123120_AddSegmentEngine")]
    partial class AddSegmentEngine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanAspire.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasIndex("ReminderAt", "Status")
                        .HasFilter("\"ReminderAt\" IS NOT NULL AND \"Status\" = 1");

                    b.HasIndex("TenantId", "AssignedToUserId", "Status");

                    b.HasIndex("TenantId", "RegardingType", "RegardingId");

                    b.HasIndex("TenantId", "Status", "Due");
            ...
            modelBuilder.Entity("CleanAspire.Domain.Entities.Consent", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "OwnerType", "OwnerId", "Purpose")
                        .IsUnique();
            ...
            modelBuilder.Entity("CleanAspire.Domain.Entities.Interaction", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "ChannelRef", "Type")
                        .IsUnique()
                        .HasDatabaseName("IX_Interactions_ChannelRef_Unique")
                        .HasFilter("\"ChannelRef\" IS NOT NULL");

                    b.HasIndex("TenantId", "Direction", "At");

                    b.HasIndex("TenantId", "HandledByUserId", "At");

                    b.HasIndex("TenantId", "Type", "At");

                    b.HasIndex("TenantId", "OwnerType", "OwnerId", "At")
                        .HasDatabaseName("IX_Interactions_Timeline");
            ...
            modelBuilder.Entity("CleanAspire.Domain.Entities.Segment", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("TEXT");
                    ...
                    b.PrimitiveCollection<string>("TargetOwnerTypes")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CleanAspire.Domain.Entities.SegmentMembership", b =>
                {
            ...
            modelBuilder.Entity("CleanAspire.Domain.Entities.Consent", b =>
                {
                    b.HasOne("CleanAspire.Domain.Entities.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId");

                    b.HasOne("CleanAspire.Domain.Entities.Contact", "Contact")
                        .WithMany()
            ...
            modelBuilder.Entity("CleanAspire.Domain.Entities.SegmentMembership", b =>
                {
                    b.HasOne("CleanAspire.Domain.Entities.Segment", "Segment")
